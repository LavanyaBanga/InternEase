...
const CreateInternship = React.lazy(() => import('./pages/organizer/CreateInternship'))
const ManageInternships = React.lazy(() => import('./pages/organizer/ManageInternships'))
      ...
      <main className={`${!isLandingPage && !isAuthPage ? 'ml-0 lg:ml-64' : ''} ${!isLandingPage ? 'pt-16' : ''}`}>
        <Suspense fallback={<LoadingSpinner />}>
          <Routes>
            ...
            <Route path="/organizer/create-internship" element={
              <ProtectedRoute role="organizer">
                <CreateInternship />
              </ProtectedRoute>
            } />
            <Route path="/organizer/manage-internships" element={
              <ProtectedRoute role="organizer">
                <ManageInternships />
              </ProtectedRoute>
            } />
