...
router.route('/apply/:opportunityId').post(protect, authorize('student', 'organizer'), applyToOpportunity);
router.route('/me').get(protect, authorize('student', 'organizer'), getMyApplications);
